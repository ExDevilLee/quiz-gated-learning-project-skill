...
- `SKILL.md`：主规则，任何 LLM Agent 都可以直接读取。
- `references/artifact-templates.md`：`README.md` / `ROADMAP.md` / `STATE.md` 模板。
- `examples/llm-training-beginner-project.md`：最小示例。
- `agents/openai.yaml`：OpenAI / Codex 相关 UI metadata，可选，不是运行必需。
